...
dat2_tr$method <- factor(dat2_tr$method, levels = c("Pitfall2", "Pitfall4", "Pitfall6", "Pitfall8", "Pitfall10", "GPD"))
pred_df$method <- factor(pred_df$method, levels = c("Pitfall2", "Pitfall4", "Pitfall6", "Pitfall8", "Pitfall10", "GPD"))
